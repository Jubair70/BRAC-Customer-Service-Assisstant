...
urlpatterns = [
    ...
    url(r'^all-complain/$', views.executed_list, name='executed_list'),
    ...
    url(r'^dashboard_monthly/$', views.dashboard_monthly, name='dashboard_monthly'),
    url(r'^dashboard_yearly/$', views.dashboard_yearly, name='dashboard_yearly'),

    url(r'^getAgents/$', views.getAgents, name='getAgents'),
    url(r'^getComments/$', views.getComments, name='getComments'),
    url(r'^getRequestedList/(?P<username>.+)/$', views.getRequestedList, name='getRequestedList'),
    url(r'^getResolvedList/(?P<username>.+)/$', views.getResolvedList, name='getResolvedList'),
    url(r'^getNewRequests/$', views.getNewRequests, name='getNewRequests'),
    url(r'^getExecutedRequests/$', views.getExecutedRequests, name='getExecutedRequests'),
    url(r'^full_view_complain/(?P<complain_id>\d+)/$', views.full_view_complain, name='full_view_complain'),
    url(r'^getRangedData/$', views.getRangedData, name='getRangedData'),
